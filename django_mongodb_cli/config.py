...
test_settings_map = {
    ...
    "django-filter": {
        "apps": {
            "src": os.path.join("test", "apps", "apps_filter.py"),
        ...
        "settings_file": {
            "test": {
                "src": os.path.join("test", "settings", "settings_filter.py"),
    ...
    "django-rest-framework": {
        "apps": {
            "src": os.path.join("test", "apps", "apps_drf.py"),
            "target": os.path.join(
        ...
        "settings_file": {
            "test": {
                "src": os.path.join("test", "settings", "settings_drf.py"),
                "target": os.path.join(
                    "src", "django-rest-framework", "tests", "conftest.py"
                ),
            },
            "migrate": {
                "src": os.path.join("test", "settings", "settings_drf_migrate.py"),
                "target": os.path.join(
                    "src", "django-rest-framework", "tests", "conftest.py"
                ),
            },
    ...
    "wagtail": {
        "apps": {
            "src": os.path.join("test", "apps", "apps_wagtail.py"),
            "target": os.path.join(
