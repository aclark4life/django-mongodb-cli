...
test_settings_map = {
    ...
    "django-filter": {
        "apps": {
            "src": os.path.join("config", "apps", "apps_filter.py"),
        ...
        "settings_file": {
            "test": {
                "src": os.path.join("config", "settings", "settings_filter.py"),
    ...
    "django-rest-framework": {
        "apps": {
            "src": os.path.join("config", "apps", "apps_drf.py"),
            "target": os.path.join(
        ...
        "settings_file": {
            "test": {
                "src": os.path.join("config", "settings", "settings_drf.py"),
                "target": os.path.join(
                    "src", "django-rest-framework", "tests", "conftest.py"
                ),
            },
            "migrate": {
                "src": os.path.join("config", "settings", "settings_drf_migrate.py"),
                "target": os.path.join(
                    "src", "django-rest-framework", "tests", "conftest.py"
                ),
            },
    ...
    "wagtail": {
        "apps": {
            "src": os.path.join("config", "apps", "apps_wagtail.py"),
            "target": os.path.join(
        ...
        "settings_file": {
            "test": {
                "src": os.path.join("config", "settings", "settings_wagtail.py"),
                "target": os.path.join(
    ...
    "django-allauth": {
        ...
        "src": os.path.join("config", "settings", "settings_allauth_regular.py"),
    ...
    "django-debug-toolbar": {
        ...
        "settings_module": "mongo_settings",
        "src": os.path.join("config", "settings", "settings_debug_toolbar.py"),
        "target": "mongo_settings.py",
        "test_dirs": ["tests"],
    },
}
