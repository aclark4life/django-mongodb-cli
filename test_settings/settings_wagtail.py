...
INSTALLED_APPS = [
    ...
    "wagtail.test.apps.MongoWagtailRedirectsAppConfig",
    "wagtail.test.testapp",
    "wagtail.test.demosite",
    "wagtail.test.snippets",
    "wagtail.test.routablepage",
    "wagtail.test.apps.MongoWagtailSearchAppConfig",
    "wagtail.test.i18n",
    ...
    "wagtail.test.apps.MongoWagtailFormsAppConfig",
    "wagtail.contrib.typed_table_block",
    "wagtail.search",
    "wagtail.test.apps.MongoWagtailEmbedsAppConfig",
    "wagtail.test.apps.MongoWagtailImagesAppConfig",
    "wagtail.sites",
    "wagtail.locales",
    "wagtail.test.apps.MongoWagtailUsersAppConfig",
    "wagtail.snippets",
    "wagtail.documents",
    "wagtail.test.apps.MongoWagtailAdminAppConfig",
    "wagtail.api.v2",
    "wagtail.test.apps.MongoWagtailAppConfig",
    "taggit",
    "rest_framework",
    "wagtail.test.apps.MongoAdminConfig",
    "wagtail.test.apps.MongoAuthConfig",
    "wagtail.test.apps.MongoContentTypesConfig",
